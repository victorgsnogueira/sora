			...
			<div className="max-w-7xl mx-auto flex items-center justify-between">
				...
				<div className="flex items-center gap-4 md:gap-8">
					...
					<button
						...
						type="button"
						className="flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-[#5865F2] rounded-lg text-xs md:text-sm font-medium hover:bg-[#4752c4] transition-colors cursor-pointer"
					>
						<svg
