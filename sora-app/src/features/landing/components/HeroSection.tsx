...
import { redirectToDiscordAuth } from '@/shared/lib/discord-auth';
			...
			<div className="relative z-20 text-center px-4 md:px-6 max-w-4xl mx-auto">
				...
				>
					<button
						...
						type="button"
						className="flex items-center justify-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-[#5865F2] rounded-xl text-base md:text-lg font-semibold hover:bg-[#4752c4] transition-all hover:scale-105 cursor-pointer"
					>
						<svg
